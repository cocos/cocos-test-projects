import { _decorator, Component, Texture2D, TextureCube, Material, Color, gfx, director, math } from 'cc';
...
@ccclass('copyBuffersToTexture')
export class copyBuffersToTexture extends Component {

    @property(Material)
    planarMat: Material | null = null;

    @property(Material)
    cubeMat: Material | null = null;

    planarTexture: Texture2D = null!;
    ...
    start () {
        ...
        const mipLevel = 1; //math.bits.log2(math.bits.min(width, height));
        ...
        this.planarTexture = new Texture2D();
        this.cubeTexture = new TextureCube();

        this.planarTexture.reset({
            width: width * 3,
            height: height * 2,
        ...
        for (let i = 0; i < mipLevel; i++) {
            ...
            const planarRegions : gfx.BufferTextureCopy[] = [];
            const cubeRegions : gfx.BufferTextureCopy[] = [];

            planarRegions.push(new gfx.BufferTextureCopy (
                0,
                width * 3,
                height * 2,
                new gfx.Offset(0, 0, 0),
                new gfx.Extent(width * 3, height * 2, depth),
                new gfx.TextureSubresLayers(i, 0, 1),
                ));

            cubeRegions.push(new gfx.BufferTextureCopy (
                0,
                width * 3,
                height * 2,
                new gfx.Offset(0, 0, 0),
                new gfx.Extent(width, height, depth),
                new gfx.TextureSubresLayers(i, 0, 1),
                ));
            cubeRegions.push(new gfx.BufferTextureCopy (
                (width) * 4,
                ...
                new gfx.Offset(0, 0, 0),
                new gfx.Extent(width, height, depth),
                new gfx.TextureSubresLayers(i, 1, 1),
                ));
            cubeRegions.push(new gfx.BufferTextureCopy (
                (width * 2) * 4,
                width * 3,
                ...
                new gfx.Offset(0, 0, 0),
                new gfx.Extent(width, height, depth),
                new gfx.TextureSubresLayers(i, 2, 1),
                ));
            ...
            cubeRegions.push(new gfx.BufferTextureCopy (
                ...
                new gfx.Offset(0, 0, 0),
                new gfx.Extent(width, height, depth),
                new gfx.TextureSubresLayers(i, 3, 1),
                ));
            cubeRegions.push(new gfx.BufferTextureCopy (
                ...
                new gfx.Offset(0, 0, 0),
                new gfx.Extent(width, height, depth),
                new gfx.TextureSubresLayers(i, 4, 1),
                ));
            cubeRegions.push(new gfx.BufferTextureCopy (
                (width * 2 + width * height * 3) * 4,
                width * 3,
                height * 2,
                new gfx.Offset(0, 0, 0),
                new gfx.Extent(width, height, depth),
                new gfx.TextureSubresLayers(i, 5, 1),
                ));

            director.root!.device.copyBuffersToTexture([buffers[i]], this.planarTexture.getGFXTexture()!, planarRegions);
            director.root!.device.copyBuffersToTexture(
                [buffers[i], buffers[i], buffers[i], buffers[i], buffers[i], buffers[i]],
                this.cubeTexture.getGFXTexture()!, cubeRegions);
