 ...
 * Module dependencies
 */
var Pe=Me.exports,De=Ae,ke=function(e){var t=Pe(e),n=Object.prototype.toString.call(e);if(De.truncateThreshold&&t.length>=De.truncateThreshold){if("[object Function]"===n)return e.name&&""!==e.name?"[Function: "+e.name+"]":"[Function]";if("[object Array]"===n)return"[ Array("+e.length+") ]";if("[object Object]"===n){var o=Object.keys(e);return"{ Object ("+(o.length>2?o.splice(0,2).join(", ")+", ...":o.join(", "))+") }"}return t}return t},Te=me,_e=Oe,Ce=ke,Le=function(e,t,n){var o=e.__flags||(e.__flags=Object.create(null));for(var r in t.__flags||(t.__flags=Object.create(null)),n=3!==arguments.length||n,o)(n||"object"!==r&&"ssfi"!==r&&"lockSsfi"!==r&&"message"!=r)&&(t.__flags[r]=o[r])},ze={exports:{}},Re=ge.exports;function qe(){this._key="chai/deep-eql__"+Math.random()+Date.now()}qe.prototype={get:function(e){return e[this._key]},set:function(e,t){Object.isExtensible(e)&&Object.defineProperty(e,this._key,{value:t,configurable:!0})}};var Be="function"==typeof WeakMap?WeakMap:qe;
/*!
...
*/function Ve(e,t,n,o){if(n&&!Ye(e)&&!Ye(t)){var r=n.get(e);r?r.set(t,o):((r=new Be).set(t,o),n.set(e,r))}}
/*!
 * Primary Export
 */function $e(e,t,n){if(n&&n.comparator)return He(e,t,n);var o=Ue(e,t);return null!==o?o:He(e,t,n)}function Ue(e,t){return e===t?0!==e||1/e==1/t:e!=e&&t!=t||!Ye(e)&&!Ye(t)&&null}
/*!
...
*/function He(e,t,n){(n=n||{}).memoize=!1!==n.memoize&&(n.memoize||new Be);var o=n&&n.comparator,r=Fe(e,t,n.memoize);if(null!==r)return r;var s=Fe(t,e,n.memoize);if(null!==s)return s;if(o){var i=o(e,t);if(!1===i||!0===i)return Ve(e,t,n.memoize,i),i;var a=Ue(e,t);if(null!==a)return a}var c=Re(e);if(c!==Re(t))return Ve(e,t,n.memoize,!1),!1;Ve(e,t,n.memoize,!0);var u=function(e,t,n,o){switch(n){case"String":case"Number":case"Boolean":case"Date":return $e(e.valueOf(),t.valueOf());case"Promise":case"Symbol":case"function":case"WeakMap":case"WeakSet":case"Error":return e===t;case"Arguments":case"Int8Array":case"Uint8Array":case"Uint8ClampedArray":case"Int16Array":case"Uint16Array":case"Int32Array":case"Uint32Array":case"Float32Array":case"Float64Array":case"Array":return Ke(e,t,o);case"RegExp":
/*!
 ...
 * @return {Boolean} result
 */
function(e,t,n,o){var r=n.length;if(0===r)return!0;for(var s=0;s<r;s+=1)if(!1===$e(e[n[s]],t[n[s]],o))return!1;return!0}(e,t,o,n);var s=We(e),i=We(t);if(s.length&&s.length===i.length)return s.sort(),i.sort(),Ke(s,i,n);if(0===o.length&&0===s.length&&0===r.length&&0===i.length)return!0;return!1}
/*!
 ...
 * @param {Mixed} value
 * @return {Boolean} result
 */(e,t,o)}}(e,t,c,n);return Ve(e,t,n.memoize,u),u}function Ge(e,t,n){if(e.size!==t.size)return!1;if(0===e.size)return!0;var o=[],r=[];return e.forEach((function(e,t){o.push([e,t])})),t.forEach((function(e,t){r.push([e,t])})),Ke(o.sort(),r.sort(),n)}
/*!
 ...
 * @param {Object} [options] (Optional)
 * @return {Boolean} result
 */function Ke(e,t,n){var o=e.length;if(o!==t.length)return!1;if(0===o)return!0;for(var r=-1;++r<o;)if(!1===$e(e[r],t[r],n))return!1;return!0}
/*!
 ...
 * Copyright(c) 2012-2014 Jake Luer <jake@alogicalparadox.com>
 * MIT Licensed
 */var pt=st,dt=ie,ht=me,yt=ft,mt=Le,bt=ie,gt=me,wt=Ze,vt=Le,xt=st,Ot=ie,Mt=me,Et=ft,Nt=Le,jt=st,St=ie,It=me,At=ft,Pt=Le,Dt="function"==typeof Object.setPrototypeOf,kt=function(){},Tt=Object.getOwnPropertyNames(kt).filter((function(e){var t=Object.getOwnPropertyDescriptor(kt,e);return"object"!=typeof t||!t.configurable})),_t=Function.prototype.call,Ct=Function.prototype.apply,Lt=ie,zt=Le,Rt=Me.exports,qt=function(e){return"function"!=typeof Object.getOwnPropertySymbols?[]:Object.getOwnPropertySymbols(e).filter((function(t){return Object.getOwnPropertyDescriptor(e,t).enumerable}))},Bt=qt;var Ft=/\s*function(?:\s|\s*\/\*[^(?:*\/)]+\*\/\s*)*([^\(\/]+)/;function Vt(e){var t="";if(void 0===e.name){var n=String(e).match(Ft);n&&(t=n[1])}else t=e.name;return t}var $t={compatibleInstance:function(e,t){return t instanceof Error&&e===t},compatibleConstructor:function(e,t){return t instanceof Error?e.constructor===t.constructor||e instanceof t.constructor:(t.prototype instanceof Error||t===Error)&&(e.constructor===t||e instanceof t)},compatibleMessage:function(e,t){var n="string"==typeof e?e:e.message;return t instanceof RegExp?t.test(n):"string"==typeof t&&-1!==n.indexOf(t)},getMessage:function(e){var t="";return e&&e.message?t=e.message:"string"==typeof e&&(t=e),t},getConstructorName:function(e){var t=e;return e instanceof Error?t=Vt(e.constructor):"function"==typeof e&&(t=Vt(e).trim()||Vt(new e)),t}};
/*!
 * Chai - isNaN utility
 ...
 * overwrite Property
 */
le.overwriteProperty=function(e,t,n){var o=Object.getOwnPropertyDescriptor(e,t),r=function(){};o&&"function"==typeof o.get&&(r=o.get),Object.defineProperty(e,t,{get:function e(){wt()||gt(this,"lockSsfi")||gt(this,"ssfi",e);var t=gt(this,"lockSsfi");gt(this,"lockSsfi",!0);var o=n(r).call(this);if(gt(this,"lockSsfi",t),void 0!==o)return o;var s=new bt.Assertion;return vt(this,s),s},configurable:!0})},
/*!
 * overwrite Method
 */
le.overwriteMethod=function(e,t,n){var o=e[t],r=function(){throw new Error(t+" is not a function")};o&&"function"==typeof o&&(r=o);var s=function(){Mt(this,"lockSsfi")||Mt(this,"ssfi",s);var e=Mt(this,"lockSsfi");Mt(this,"lockSsfi",!0);var t=n(r).apply(this,arguments);if(Mt(this,"lockSsfi",e),void 0!==t)return t;var o=new Ot.Assertion;return Nt(this,o),o};xt(s,t,!1),e[t]=Et(s,t)},
/*!
 * Add a chainable method
 */
le.addChainableMethod=function(e,t,n,o){"function"!=typeof o&&(o=function(){});var r={method:n,chainingBehavior:o};e.__methods||(e.__methods={}),e.__methods[t]=r,Object.defineProperty(e,t,{get:function(){r.chainingBehavior.call(this);var n=function(){It(this,"lockSsfi")||It(this,"ssfi",n);var e=r.method.apply(this,arguments);if(void 0!==e)return e;var t=new St.Assertion;return Pt(this,t),t};if(jt(n,t,!0),Dt){var o=Object.create(this);o.call=_t,o.apply=Ct,Object.setPrototypeOf(n,o)}else{Object.getOwnPropertyNames(e).forEach((function(t){if(-1===Tt.indexOf(t)){var o=Object.getOwnPropertyDescriptor(e,t);Object.defineProperty(n,t,o)}}))}return Pt(this,n),At(n)},configurable:!0})},
/*!
 ...
 */
le.compareByInspect=function(e,t){return Rt(e)<Rt(t)?-1:1},
/*!
 * Get own enumerable property symbols method
 */
le.getOwnEnumerablePropertySymbols=qt,
/*!
 * Get own enumerable properties method
 */
le.getOwnEnumerableProperties=function(e){return Object.keys(e).concat(Bt(e))},
/*!
...
/*!
   * Assert interface
   */
var c=Yt;e.use(c)}(ie);const Xt=ie.expect;const Zt=new class{async run(){console.info("🚀 ~ file: runner.ts ~ line 26 ~ TestRunner ~ run ~ run"),await y(),console.log("🚀 ~ file: runner.ts ~ line 35 ~ TestRunner ~ run ~ getassemblyData"),cc.profiler.hideStats();try{const{platformIndex:e,classList:t,testScript:o,ip:r,port:s,timeout:i,jobId:a}=h("all");console.log("🚀 ~ file: runner.ts ~ line 36 ~ TestRunner ~ run ~ ip",r),console.log("🚀 ~ file: runner.ts ~ line 36 ~ TestRunner ~ run ~ port",s),console.log("🚀 ~ file: runner.ts ~ line 36 ~ TestRunner ~ run ~ classList",t),0===t.length&&cc.game.end(),(()=>{console.log("🚀 ~ file: reset-api.ts ~ line 6 ~ platformIndex");const{ip:e,port:t,platformIndex:n,jobId:o}=h("all");console.log("🚀 ~ file: reset-api.ts ~ line 10 ~ platformIndex",n);const{log:r,error:s,timeEnd:i}=window.console;window.console.log=async(...e)=>{r(...e);const t=e.join(" ");await q("runtime/log",{type:"info",msg:t,platformIndex:n,jobId:o})},window.console.error=async(...e)=>{s(...e);const t=e.join(" ");await q("runtime/log",{type:"error",msg:t,platformIndex:n,jobId:o})},window.addEventListener("error",(e=>{console.error(e.message)})),window.console.timeEnd=async e=>{i(e),(null==e?void 0:e.startsWith("LoadScene"))&&await q("runtime/log",{type:"info",msg:e,platformIndex:n,jobId:o})},cc.debug._resetDebugSetting(2)})(),z.platformIndex=e,console.info("🚀 ~ file: runner.ts ~ line 56 ~ TestRunner ~ run ~ initJson.platformIndex",z.platformIndex),console.info("init json------------------",z),console.info("addPlatform",z),await j(r,s),console.info("createWebsoket"),await A(e,"Test Start"),console.info("startTest"),await re(a,e,t,o),await function(e,t){return new Promise((o=>{const r={state:n.END,platformIndex:e,jobId:h("jobId"),logs:t,imgList:T};console.log("🚀 ~ file: client.ts ~ line 137 ~ returnnewPromise ~ imgList",r.jobId),clearInterval(d),S(r,o)}))}(e,"Test End"),cc.game.end()}catch(e){console.info("🚀 ~ file: runner.ts ~ line 82 ~ TestRunner ~ run ~ error"),console.error(`【automation error】 ${e.stack?e.stack:e}`),cc.game.end()}}};export{Zt as Runner,G as TestClassInfo,C as captureOneImage,H as ensureAfterDraw,U as ensureAfterPhysics,F as ensureFirstSceneLaunched,$ as ensureFrameEnd,V as ensureSceneUpdated,Xt as expect,h as getPlatformInfo,oe as getTestObj,y as getassemblyData,m as isArrayBuffer,w as isEmptyObject,x as isMiniGame,g as isObject,B as loadScene,b as promisify,re as runAllTestObj,Y as runScene,Z as setup,X as setupFunc,v as sleep,te as teardown,ee as teardownFunc,ne as testCase,Q as testClass,J as testClassMap,_ as waitForNextFrame};
